...
def main():
    ...
    # Sidebar navigation
    menu = ["Calculadora de Juros Compostos", "Calculadora de Juros Simples", "Calculadora de Anuidade"]
    choice = st.sidebar.selectbox("Selecionar opção", menu)

    if choice == "Calculadora de Juros Compostos":
    ...
    elif choice == "Calculadora de Juros Simples":
